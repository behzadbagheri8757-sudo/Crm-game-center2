...
(function (global) {
  const ICO = {
    ...
    target: '<svg viewBox="0 0 48 48" width="42" height="42" fill="none"><defs><linearGradient id="dmtTargetGrad" x1="6" y1="6" x2="42" y2="42" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#F6E4A8"/><stop offset="1" stop-color="#A67A1F"/></linearGradient></defs><circle cx="22" cy="26" r="15" stroke="url(#dmtTargetGrad)" stroke-width="2.2" fill="none"/><circle cx="22" cy="26" r="9.5" stroke="url(#dmtTargetGrad)" stroke-width="2.1" fill="none"/><circle cx="22" cy="26" r="4" fill="url(#dmtTargetGrad)"/><path d="M24.2 24.2 L36.5 11.5" stroke="url(#dmtTargetGrad)" stroke-width="2.2" stroke-linecap="round"/><path d="M22 26 L27.2 23.2 L24.8 28.4 Z" fill="url(#dmtTargetGrad)"/><path d="M36.5 11.5 L36.5 16.2 M36.5 11.5 L31.8 11.5" stroke="url(#dmtTargetGrad)" stroke-width="1.9" stroke-linecap="round"/></svg>',
    growth: '<svg viewBox="0 0 48 48" width="36" height="36" fill="none"><defs><linearGradient id="dmtGrowBar" x1="0" y1="42" x2="0" y2="8" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#C89B3C"/><stop offset="1" stop-color="#F3D98B"/></linearGradient></defs><rect x="6" y="28" width="8" height="12" rx="2" fill="url(#dmtGrowBar)" opacity=".78"/><rect x="18" y="20" width="8" height="20" rx="2" fill="url(#dmtGrowBar)" opacity=".92"/><rect x="30" y="12" width="8" height="28" rx="2" fill="url(#dmtGrowBar)"/><path d="M8 25 L17 17 L26 19 L35 7" stroke="#F5E6B8" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M35 7 L35 12.5 M35 7 L29.5 7" stroke="#F5E6B8" stroke-width="2.2" stroke-linecap="round"/></svg>',
