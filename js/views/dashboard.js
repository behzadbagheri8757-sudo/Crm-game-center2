...
(function (global) {
  const ICO = {
    ...
    target: '<svg viewBox="0 0 48 48" width="40" height="40" fill="none" aria-hidden="true"><defs><linearGradient id="tg" x1="8" y1="6" x2="42" y2="40" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#FFE4A8"/><stop offset=".45" stop-color="#F0B84A"/><stop offset="1" stop-color="#C47820"/></linearGradient><linearGradient id="tgCore" x1="26" y1="16" x2="36" y2="32" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#FFE9B0"/><stop offset="1" stop-color="#E8A028"/></linearGradient><linearGradient id="tgArrow" x1="2" y1="24" x2="22" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#F5D78A"/><stop offset="1" stop-color="#E8B84A"/></linearGradient></defs><circle cx="31" cy="24" r="12.4" stroke="url(#tg)" stroke-width="2.25" fill="none"/><circle cx="31" cy="24" r="7.85" stroke="url(#tg)" stroke-width="2.05" fill="none"/><circle cx="31" cy="24" r="3.1" fill="url(#tgCore)"/><path d="M20.2 24 L11.8 16.6 L11.8 31.4 Z" fill="url(#tgArrow)"/><path d="M11.8 24 L2.8 24" stroke="url(#tgArrow)" stroke-width="2.4" stroke-linecap="round"/><path d="M6.2 24 L1.6 18.2 M6.2 24 L1.6 29.8" stroke="url(#tgArrow)" stroke-width="1.95" stroke-linecap="round"/></svg>',
    growth: '<svg viewBox="0 0 48 48" width="34" height="34" fill="none" aria-hidden="true"><defs><linearGradient id="gb" x1="0" y1="44" x2="0" y2="8" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#A67A24"/><stop offset=".5" stop-color="#D4A84A"/><stop offset="1" stop-color="#F5E6B8"/></linearGradient><linearGradient id="gtl" x1="2" y1="24" x2="44" y2="2" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#E0B84A"/><stop offset="1" stop-color="#FFF3C8"/></linearGradient></defs><rect x="5" y="30" width="7.5" height="12" rx="1.5" fill="url(#gb)" opacity=".68"/><rect x="15.5" y="22" width="7.5" height="20" rx="1.5" fill="url(#gb)" opacity=".82"/><rect x="26" y="14" width="7.5" height="28" rx="1.5" fill="url(#gb)" opacity=".92"/><rect x="36.5" y="6" width="7.5" height="36" rx="1.5" fill="url(#gb)"/><path d="M4 26 L13 18 L22 21 L31 11 L39.5 4.5" stroke="url(#gtl)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M39.5 4.5 L32.8 3.2 L34.6 10.8 Z" fill="#F8EEC0"/></svg>',
