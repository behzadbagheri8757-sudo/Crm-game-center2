...
(function (global) {
  const ICO = {
    ...
    growth: '<svg viewBox="0 0 24 24" width="56" height="56" style="width:56px;height:56px" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M14 14C14 13.4477 14.4477 13 15 13H17C17.5523 13 18 13.4477 18 14V18C18 18.5523 17.5523 19 17 19H15C14.4477 19 14 18.5523 14 18V14Z" stroke="#B8862C" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10 16C10 15.4477 10.4477 15 11 15H13C13.5523 15 14 15.4477 14 16V18C14 18.5523 13.5523 19 13 19H11C10.4477 19 10 18.5523 10 18V16Z" stroke="#B8862C" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path><path d="M6 17C6 16.4477 6.44772 16 7 16H9C9.55228 16 10 16.4477 10 17V18C10 18.5523 9.55228 19 9 19H7C6.44772 19 6 18.5523 6 18V17Z" stroke="#B8862C" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path><path d="M4 19H20" stroke="#B8862C" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5.5 11C6.0529 11.285 6.81216 11.4045 7.72169 11.3498C8.63123 11.295 9.6678 11.0674 10.7548 10.6836C11.8418 10.2999 12.9515 9.76988 14.0019 9.13275C15.0523 8.49563 16.0166 7.76767 16.8235 7.00266M14.7802 6.59182L16.9845 6.89165L16.369 9.3436" stroke="#B8862C" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>',
