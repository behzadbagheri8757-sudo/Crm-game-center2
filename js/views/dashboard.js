...
(function (global) {
  const ICO = {
    ...
    // New target: arrow hitting bullseye
    target: '<svg viewBox="0 0 40 40" fill="none" stroke="#C89B3C" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="20" cy="20" r="15"/><circle cx="20" cy="20" r="10"/><circle cx="20" cy="20" r="5"/><circle cx="20" cy="20" r="2.5" fill="#C89B3C" stroke="none"/><line x1="36" y1="4" x2="4" y2="36"/><polygon points="4,36 1,33 7,39" fill="#C89B3C" stroke="none"/><line x1="36" y1="4" x2="38" y2="2"/><line x1="36" y1="4" x2="34" y2="0"/><line x1="36" y1="4" x2="39" y2="5"/></svg>',
    // New growth: zigzag chart with upward arrow
    growth: '<svg viewBox="0 0 40 40" fill="none" stroke="#C89B3C" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="4,34 9,26 14,29 19,20 24,23 29,14 34,8"/><line x1="34" y1="8" x2="34" y2="2"/><polygon points="34,2 31,5 37,5" fill="#C89B3C" stroke="none"/><line x1="4" y1="34" x2="34" y2="34" stroke-width="1.2" stroke-dasharray="2,2" opacity="0.35"/></svg>',
