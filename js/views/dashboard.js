...
(function (global) {
  const ICO = {
    ...
    target: '<svg viewBox="0 0 24 24" width="40" height="40" fill="none" stroke="#C89B3C" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="13" cy="12" r="8"/><circle cx="13" cy="12" r="4.5"/><circle cx="13" cy="12" r="1.6"/><path d="M2 12h6.5"/><path d="M5.5 9.2 L8.5 12 L5.5 14.8"/></svg>',
    growth: '<svg viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="#C89B3C" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 20V12"/><path d="M9 20V8"/><path d="M14 20V4"/><path d="M3 13l5-5 3 2.5 6-7"/><path d="M14 3.5h4.5v4.5"/></svg>',
