...
(function (global) {
  const ICO = {
    ...
    target: '<svg viewBox="0 0 48 48" width="40" height="40" fill="none" aria-hidden="true"><defs><linearGradient id="tg" x1="4" y1="4" x2="44" y2="44" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#F6E4A8"/><stop offset="1" stop-color="#A67A1F"/></linearGradient></defs><circle cx="30" cy="24" r="13.2" stroke="url(#tg)" stroke-width="2.2" fill="none"/><circle cx="30" cy="24" r="8.4" stroke="url(#tg)" stroke-width="2.1" fill="none"/><circle cx="30" cy="24" r="3.2" fill="url(#tg)"/><!-- clear arrowhead pointing RIGHT into bullseye; tip at center, no geometry past center --><path d="M30 24 L19.5 18.5 L19.5 29.5 Z" fill="url(#tg)"/><!-- shaft --><path d="M19.5 24 L5.5 24" stroke="url(#tg)" stroke-width="2.3" stroke-linecap="round"/><!-- fletching: classic rear feathers (angled back, smaller) --><path d="M8.2 24 L3.5 19 M8.2 24 L3.5 29" stroke="url(#tg)" stroke-width="1.85" stroke-linecap="round"/></svg>',
    growth: '<svg viewBox="0 0 48 48" width="34" height="34" fill="none" aria-hidden="true"><defs><linearGradient id="gb" x1="0" y1="44" x2="0" y2="8" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#B3812E"/><stop offset="1" stop-color="#F3D98B"/></linearGradient></defs><!-- three ascending bars --><rect x="5.5" y="29" width="8" height="13" rx="1.6" fill="url(#gb)" opacity=".7"/><rect x="18" y="20" width="8" height="22" rx="1.6" fill="url(#gb)" opacity=".88"/><rect x="30.5" y="11" width="8" height="31" rx="1.6" fill="url(#gb)"/><!-- trend line entirely ABOVE the bars --><path d="M4.5 24 L15.5 15.5 L27 12.5 L40 4.5" stroke="#F5E6B8" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><!-- arrowhead continuing the line (up-right) --><path d="M40 4.5 L34 5.8 M40 4.5 L38.2 10.5" stroke="#F5E6B8" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
