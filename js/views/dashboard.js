...
(function (global) {
  const ICO = {
    ...
    target: '<svg viewBox="0 0 463 463" width="42" height="42" style="width:42px;height:42px" fill="none" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M335,99.383c0-10.818,4.213-20.989,11.862-28.638L392,25.607v34.787l-57,57V99.383z M352,279.5c0,92.911-75.589,168.5-168.5,168.5S15,372.412,15,279.5S90.589,111,183.5,111c43.763,0,83.679,16.775,113.667,44.226 l-23.354,23.354C249.825,157.091,218.165,144,183.5,144C108.785,144,48,204.786,48,279.5S108.785,415,183.5,415 S319,354.215,319,279.5c0-34.665-13.09-66.325-34.58-90.313l23.354-23.354C335.226,195.821,352,235.737,352,279.5z M208,279.5 c0,13.509-10.99,24.5-24.5,24.5S159,293.01,159,279.5s10.99-24.5,24.5-24.5c4.027,0,7.827,0.983,11.182,2.711l-16.485,16.485 c-2.929,2.929-2.929,7.678,0,10.606c1.465,1.464,3.385,2.197,5.304,2.197s3.839-0.732,5.304-2.197l16.485-16.485 C207.018,271.674,208,275.474,208,279.5z M205.61,246.784c-6.313-4.28-13.924-6.784-22.109-6.784c-21.78,0-39.5,17.72-39.5,39.5 s17.72,39.5,39.5,39.5s39.5-17.72,39.5-39.5c0-8.185-2.503-15.796-6.784-22.109l23.548-23.548 C249.906,246.317,256,262.208,256,279.5c0,39.977-32.523,72.5-72.5,72.5S111,319.477,111,279.5s32.523-72.5,72.5-72.5 c17.292,0,33.183,6.094,45.657,16.236L205.61,246.784z M239.81,212.584C224.58,199.748,204.93,192,183.5,192 c-48.248,0-87.5,39.252-87.5,87.5s39.252,87.5,87.5,87.5s87.5-39.252,87.5-87.5c0-21.429-7.748-41.08-20.584-56.31l23.384-23.384 c18.782,21.257,30.2,49.165,30.2,79.693c0,66.444-54.056,120.5-120.5,120.5S63,345.944,63,279.5S117.056,159,183.5,159 c30.529,0,58.437,11.418,79.693,30.2L239.81,212.584z M392.255,116.138c-7.649,7.65-17.819,11.862-28.637,11.862h-18.011l57-57 h34.787L392.255,116.138z" stroke="#B33A3A" stroke-width="8.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M462.429,60.63c-1.16-2.803-3.896-4.63-6.929-4.63H407V7.5c0-3.034-1.827-5.768-4.63-6.929 c-2.804-1.161-6.028-0.519-8.174,1.626l-57.941,57.941C325.773,70.621,320,84.558,320,99.383v33.011l-12.225,12.225 C275.063,114.456,231.399,96,183.5,96C82.318,96,0,178.318,0,279.5S82.318,463,183.5,463S367,380.683,367,279.5 c0-47.899-18.455-91.562-48.618-124.275L330.607,143h33.011c14.824,0,28.761-5.773,39.244-16.256l57.941-57.941 C462.948,66.659,463.59,63.433,462.429,60.63z" stroke="#A77A24" stroke-width="8.5" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>',
    // growth icon – bar chart. viewBox crop tightened symmetrically around the drawn strokes
    // (previous crop had ~1.5 units of dead space on the right vs ~0.7 on the left — fixed).
    // stroke-width reduced 1.6 -> 1.3: at this icon's render scale that was landing at roughly
    // 4x the pixel stroke of the other dashboard icons relative to icon size; 1.3 brings the
    // stroke-width/icon-size ratio in line with the rest of the icon set (~0.075 vs ~0.065).
    growth: '<svg viewBox="3.3 5.9 17.4 13.8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M14 14C14 13.4477 14.4477 13 15 13H17C17.5523 13 18 13.4477 18 14V18C18 18.5523 17.5523 19 17 19H15C14.4477 19 14 18.5523 14 18V14Z" stroke="#B8862C" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10 16C10 15.4477 10.4477 15 11 15H13C13.5523 15 14 15.4477 14 16V18C14 18.5523 13.5523 19 13 19H11C10.4477 19 10 18.5523 10 18V16Z" stroke="#B8862C" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M6 17C6 16.4477 6.44772 16 7 16H9C9.55228 16 10 16.4477 10 17V18C10 18.5523 9.55228 19 9 19H7C6.44772 19 6 18.5523 6 18V17Z" stroke="#B8862C" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M4 19H20" stroke="#B8862C" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5.5 11C6.0529 11.285 6.81216 11.4045 7.72169 11.3498C8.63123 11.295 9.6678 11.0674 10.7548 10.6836C11.8418 10.2999 12.9515 9.76988 14.0019 9.13275C15.0523 8.49563 16.0166 7.76767 16.8235 7.00266M14.7802 6.59182L16.9845 6.89165L16.369 9.3436" stroke="#B8862C" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>',
