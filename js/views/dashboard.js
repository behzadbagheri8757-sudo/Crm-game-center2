...
(function (global) {
  const ICO = {
    ...
    target: '<svg viewBox="0 0 48 48" width="40" height="40" fill="none" aria-hidden="true"><defs><linearGradient id="tg" x1="6" y1="6" x2="44" y2="42" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#F8E9B0"/><stop offset=".5" stop-color="#E0B84A"/><stop offset="1" stop-color="#A67A1F"/></linearGradient><linearGradient id="tgCore" x1="26" y1="18" x2="36" y2="30" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#F6E4A8"/><stop offset="1" stop-color="#C89B3C"/></linearGradient></defs><circle cx="31" cy="24" r="12.5" stroke="url(#tg)" stroke-width="2.2" fill="none"/><circle cx="31" cy="24" r="7.9" stroke="url(#tg)" stroke-width="2" fill="none"/><circle cx="31" cy="24" r="3.05" fill="url(#tgCore)"/><path d="M21.8 24 L14.6 18.6 L14.6 29.4 Z" fill="url(#tg)"/><path d="M14.6 24 L3.8 24" stroke="url(#tg)" stroke-width="2.3" stroke-linecap="round"/><path d="M7.2 24 L2.8 19.2 M7.2 24 L2.8 28.8" stroke="url(#tg)" stroke-width="1.85" stroke-linecap="round"/></svg>',
    growth: '<svg viewBox="0 0 48 48" width="34" height="34" fill="none" aria-hidden="true"><defs><linearGradient id="gb" x1="0" y1="44" x2="0" y2="6" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#9A6B22"/><stop offset=".4" stop-color="#D4A84A"/><stop offset="1" stop-color="#F5E6B8"/></linearGradient><linearGradient id="gtl" x1="3" y1="24" x2="42" y2="3" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#D4A84A"/><stop offset="1" stop-color="#F8EFC8"/></linearGradient></defs><rect x="4.5" y="29.5" width="7.8" height="12.5" rx="1.55" fill="url(#gb)" opacity=".7"/><rect x="17.2" y="20" width="7.8" height="22" rx="1.55" fill="url(#gb)" opacity=".88"/><rect x="29.9" y="10" width="7.8" height="32" rx="1.55" fill="url(#gb)"/><path d="M4.5 22.8 L16 15.2 L27.5 11.5 L39 4.8" stroke="url(#gtl)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M39 4.8 L33.2 6 L36.8 10.8 Z" fill="#F5E6B8"/></svg>',
