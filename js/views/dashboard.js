...
(function (global) {
  const ICO = {
    ...
    target: '<svg viewBox="0 0 48 48" width="40" height="40" fill="none" aria-hidden="true"><defs><linearGradient id="tg" x1="8" y1="6" x2="42" y2="40" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#FFE4A8"/><stop offset=".45" stop-color="#F0B84A"/><stop offset="1" stop-color="#C47820"/></linearGradient><linearGradient id="tgCore" x1="26" y1="16" x2="36" y2="32" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#FFE9B0"/><stop offset="1" stop-color="#E8A028"/></linearGradient><linearGradient id="tgArrow" x1="2" y1="24" x2="22" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#F5D78A"/><stop offset="1" stop-color="#E8B84A"/></linearGradient></defs><circle cx="31" cy="24" r="12.4" stroke="url(#tg)" stroke-width="2.25" fill="none"/><circle cx="31" cy="24" r="7.85" stroke="url(#tg)" stroke-width="2.05" fill="none"/><circle cx="31" cy="24" r="3.1" fill="url(#tgCore)"/><path d="M19.4 24 L12.2 17.8 L12.2 30.2 Z" fill="url(#tgArrow)"/><path d="M12.2 24 L3.2 24" stroke="url(#tgArrow)" stroke-width="2.35" stroke-linecap="round"/><path d="M6.4 24 L2.2 18.8 M6.4 24 L2.2 29.2" stroke="url(#tgArrow)" stroke-width="1.9" stroke-linecap="round"/></svg>',
    growth: '<svg viewBox="0 0 48 48" width="34" height="34" fill="none" aria-hidden="true"><defs><linearGradient id="gb" x1="0" y1="44" x2="0" y2="8" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#A67A24"/><stop offset=".5" stop-color="#D4A84A"/><stop offset="1" stop-color="#F5E6B8"/></linearGradient><linearGradient id="gtl" x1="2" y1="20" x2="44" y2="2" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#E0B84A"/><stop offset="1" stop-color="#FFF3C8"/></linearGradient></defs><rect x="5" y="30" width="8" height="12" rx="1.6" fill="url(#gb)" opacity=".68"/><rect x="18" y="21" width="8" height="21" rx="1.6" fill="url(#gb)" opacity=".86"/><rect x="31" y="11" width="8" height="31" rx="1.6" fill="url(#gb)"/><path d="M4 21 L15.5 14.5 L27 10.5 L41 3.5" stroke="url(#gtl)" stroke-width="2.15" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M41 3.5 L35.2 4.4 L38.6 8.8 Z" fill="#F8EEC0"/></svg>',
