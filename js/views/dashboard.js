...
(function (global) {
  const ICO = {
    ...
    target: '<svg viewBox="0 0 48 48" width="40" height="40" fill="none" aria-hidden="true"><defs><linearGradient id="tg" x1="6" y1="6" x2="42" y2="42" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#F6E4A8"/><stop offset="1" stop-color="#A67A1F"/></linearGradient></defs><circle cx="28" cy="24" r="14" stroke="url(#tg)" stroke-width="2.2" fill="none"/><circle cx="28" cy="24" r="9" stroke="url(#tg)" stroke-width="2.1" fill="none"/><circle cx="28" cy="24" r="3.6" fill="url(#tg)"/><path d="M28 24 L22.2 20.6 L22.2 27.4 Z" fill="url(#tg)"/><path d="M22.5 24 L8 24" stroke="url(#tg)" stroke-width="2.2" stroke-linecap="round"/><path d="M8 24 L11.5 20.2 M8 24 L11.5 27.8" stroke="url(#tg)" stroke-width="1.9" stroke-linecap="round"/></svg>',
    growth: '<svg viewBox="0 0 48 48" width="34" height="34" fill="none" aria-hidden="true"><defs><linearGradient id="gb" x1="0" y1="44" x2="0" y2="10" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#B3812E"/><stop offset="1" stop-color="#F3D98B"/></linearGradient></defs><rect x="6" y="32" width="8" height="10" rx="1.8" fill="url(#gb)" opacity=".7"/><rect x="19" y="24" width="8" height="18" rx="1.8" fill="url(#gb)" opacity=".88"/><rect x="32" y="16" width="8" height="26" rx="1.8" fill="url(#gb)"/><path d="M8 28 L18 20 L28 22 L38 8" stroke="#F5E6B8" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M38 8 L32.5 9.2 M38 8 L36.8 13.5" stroke="#F5E6B8" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
