...
(function (global) {
  const ICO = {
    ...
    target: '<svg viewBox="0 0 48 48" width="40" height="40" style="width:40px;height:40px" fill="none" aria-hidden="true" focusable="false"><circle cx="24" cy="24" r="22" fill="#C89B3C"/><circle cx="24" cy="24" r="15.2" stroke="#fff" stroke-width="2.8"/><circle cx="24" cy="24" r="9.2" stroke="#fff" stroke-width="2.8"/><circle cx="24" cy="24" r="4.1" fill="#fff"/><path d="M39.2 8.8 24.2 23.8" stroke="#fff" stroke-width="2.9" stroke-linecap="round"/><path d="M39.2 8.8 32.8 9.3 38.7 15.2Z" fill="#fff"/><path d="M9.1 39.1 6.2 35.2 10.2 36.5 13.1 39.4Z" fill="#fff"/><path d="M9.8 36.6 6.8 39.6" stroke="#fff" stroke-width="1.7" stroke-linecap="round"/><path d="M12.1 38.9 9.1 42" stroke="#fff" stroke-width="1.7" stroke-linecap="round"/></svg>',
    growth: '<svg viewBox="0 0 48 48" width="40" height="40" style="width:40px;height:40px" fill="none" aria-hidden="true" focusable="false"><circle cx="24" cy="24" r="22" fill="#C89B3C"/><rect x="8" y="29" width="7" height="11" rx="1.2" fill="#fff"/><rect x="18.5" y="23" width="7" height="17" rx="1.2" fill="#fff"/><rect x="29" y="17" width="7" height="23" rx="1.2" fill="#fff"/><path d="M7.2 27.8 15.3 19.8 21.8 25.7 28.7 18.8 35.2 24.1 41 17.4" stroke="#fff" stroke-width="2.8" stroke-linecap="round" stroke-linejoin="round"/><path d="M41 17.4 35.3 17.8 39.8 22.2Z" fill="#fff"/></svg>',
