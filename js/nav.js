...
const BOTTOM_NAV_ITEMS = [
  {
    ...
    spaPath: '/dashboard',
    label: 'داشبورد',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.55" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><path d="M14 3v4a1 1 0 0 0 1 1h4"/><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z"/><path d="M9 7l1 0"/><path d="M9 13l6 0"/><path d="M13 17l2 0"/></svg>'
  },
  {
    id: 'customers',
    href: '#/customers',
    spaPath: '/customers',
    label: 'مشتریان',
    icon: '<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.55" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="7.2" r="3.15"/><path d="M3.4 19.8v-.9a4.6 4.6 0 0 1 4.6-4.6h1.5a4.6 4.6 0 0 1 4.6 4.6v.9"/><path d="M16.4 4.3a3 3 0 0 1 0 5.7"/><path d="M17.6 14.5a4 4 0 0 1 2.9 3.7v1.6"/></svg>'
  },
  {
    id: 'products',
    href: '#/products',
    spaPath: '/products',
    label: 'اجناس',
    icon: '<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.55" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3.2 4 7.5v9l8 4.3 8-4.3v-9L12 3.2z"/><path d="M12 12 4 7.5M12 12l8-4.5M12 12v8.8"/></svg>'
  },
  {
    id: 'invoices',
    href: '#/invoices',
  ...
  },
  {
    ...
    href: '#more',
    label: 'بیشتر',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.55" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><path d="M5 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0"/><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0"/><path d="M19 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0"/></svg>'
  },
];
